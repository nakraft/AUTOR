...
INSERT ALL 
  INTO Invoice(id, sid, eid, cid, start_timeslot_week, start_timeslot_day, start_timeslot, end_timeslot_week, end_timeslot_day, end_timeslot, vin)  VALUES (1, 30003, 123405678, 10501, 1, 2, 1, 1, 2, 2, 'P39VN198')
  INTO Invoice(id, sid, eid, cid, start_timeslot_week, start_timeslot_day, start_timeslot, end_timeslot_week, end_timeslot_day, end_timeslot, vin)  VALUES (2, 30003, 123450678, 10010, 1, 2, 1, 1, 2, 2, '39YVS415')
  ...
  INTO Invoice(id, sid, eid, cid, start_timeslot_week, start_timeslot_day, start_timeslot, end_timeslot_week, end_timeslot_day, end_timeslot, vin, status)  VALUES (4, 30002, 423186759, 10035, 2, 4, 2, 2, 4, 6, '9R2UHP54', 1)
  INTO Invoice(id, sid, eid, cid, start_timeslot_week, start_timeslot_day, start_timeslot, end_timeslot_week, end_timeslot_day, end_timeslot, vin, status)  VALUES (5, 30002, 125689347, 10053, 2, 1, 3, 2, 1, 6, '5TR3K914', 1)
  -- INTO Invoice(id, sid, eid, cid, start_timeslot_week, start_timeslot_day, start_timeslot, end_timeslot_week, end_timeslot_day, end_timeslot, vin, status)  VALUES (6, 30002, 789123456, 10010, 2, 6, 2, 2, 6, 8, '15DC9A87', 1) THIS IS AN INVALID SERVICE 
  INTO Invoice(id, sid, eid, cid, start_timeslot_week, start_timeslot_day, start_timeslot, end_timeslot_week, end_timeslot_day, end_timeslot, vin, status)  VALUES (7, 30002, 125689347, 10001, 3, 5, 5, 3, 5, 8, '18S5R2D8', 1)
SELECT * 
  FROM dual;