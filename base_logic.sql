...
CREATE TABLE Calendar (
	...
	sid NUMBER(10) NOT NULL,
    eid NUMBER NOT NULL CHECK (eid BETWEEN 100000000 and 999999999),
	id NUMBER(10),
...
-- CREATE TRIGGER add_receptionist_as_employee
--     BEFORE UPDATE ON Service_Center
--     BEGIN
--         IF receptionist_id IS NOT NULL THEN 
--             INSERT INTO Employee (eid, sid, role) 
--             VALUES (receptionist_id, sid, 'receptionist');
--         END IF; 
--     END;
-- /
...
--     FOR EACH ROW
--     BEGIN
--         IF :new.receptionist_id IS NOT NULL THEN 
--             INSERT INTO Employee (eid, sid, role) 
--             VALUES (:new.receptionist_id, :new.sid, 'receptionist');
--         END IF;
--     END;
-- /
...
--     BEFORE UPDATE ON Service_Center
--     BEGIN
--         IF UPDATING('receptionist_id') THEN
--             INSERT INTO Employee (eid, sid, role) 
--             VALUES (receptionist_id, sid, 'receptionist');
--         END IF;
--     END;
